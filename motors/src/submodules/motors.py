...
class MotorsSync():
    ...
    def read_position(self):
        ...
        self.dxl_present_positions = np.array([self.groupSyncRead_position.getData(id, self.ADDR_PRESENT_POSITION, self.LEN_PRESENT_POSITION) for id in self.ids])
    ...
    def read_current(self):
        ...
        # Get Dynamixel#1 present position value
        dxl_present_currents = np.array([self.groupSyncRead_current.getData(id, self.ADDR_PRESENT_CURRENT, self.LEN_PRESENT_CURRENT) for id in self.ids])
